...
class Admin::ServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_service" do
    assert_difference('Admin::Service.count') do
      post admin_services_url, params: { admin_service: { building_id: @admin_service.building_id, description: @admin_service.description, name: @admin_service.name, unit: @admin_service.unit, unit_price: @admin_service.unit_price, user_id: @admin_service.user_id } }
    end
  ...
  test "should update admin_service" do
    patch admin_service_url(@admin_service), params: { admin_service: { building_id: @admin_service.building_id, description: @admin_service.description, name: @admin_service.name, unit: @admin_service.unit, unit_price: @admin_service.unit_price, user_id: @admin_service.user_id } }
